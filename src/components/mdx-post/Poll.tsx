    ...
    <>
      <div className="mx-auto">
        <div className="bg-gray-100 p-6 mb-12 border border-gray-300 rounded-xl flex flex-col items-center ">
          ...
          <div>
            {props.answers.map((answer, index) => (
              <div className="form-check">
                ...
                />
                <label
                  className="max-w-sm form-check-label inline-block text-gray-800"
          ...
          <button
            className="bg-blue-500 hover:bg-blue-300 text-white rounded-lg py-2 px-4 mt-4 disabled:bg-slate-300 disabled:text-slate-500"
