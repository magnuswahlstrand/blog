...
{{< asciicast src="/casts/pubsub-with-dlq/terraform.cast" poster="npt:0:04" loop="true" rows="16" cols="100" autoplay="true">}}
...
{{< asciicast src="/casts/pubsub-with-dlq/process-messages.cast" poster="npt:0:04" loop="true" rows="16" cols="100" autoplay="true">}}
