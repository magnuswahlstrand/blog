...
{{< asciicast src="/casts/trpc-with-lambda-function-urls-on-aws/ts-prompt.cast" poster="npt:0:04" loop="true" rows="14" cols="80" autoplay="true">}}
...
{{% table_caption %}} Our architecture diagram 🙌{{% /table_caption %}}
...
{{% table_caption %}} More details over
...
![tRPC type error 1](/img/trpc-with-lambda-function-urls-on-aws/error_1.png)

Same if the parameter is the wrong type:
![tRPC type error 2](/img/trpc-with-lambda-function-urls-on-aws/error_2.png)
...
{{% sidenote title="Note:" %}} I have never developed command line clients in Typescript before. There are most likely better ways to write the following application 🤓 {{% /sidenote %}}
